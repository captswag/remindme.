...
@SuppressLint("InflateParams") public class All extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	SimpleAdapter adapter = new SimpleAdapter(this, list, R.layout.listview_layout_all, new String[] {"appointment", "task"}, new int[] {R.id.row1, R.id.row2});
